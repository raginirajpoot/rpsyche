      ...
      <header className="flex justify-between items-center border-b border-stone-200/80 pb-6">
        ...
        <div>
          {user ? (
            ...
            <button
              onClick={login}
              className="inline-flex items-center gap-2 text-xs bg-[#1C1917] text-[#FBF9F5] px-4 py-2 rounded-xl hover:opacity-90 transition font-medium"
            >
      ...
      {!user ? (
        <div className="text-center py-20 space-y-4">
          ...
          <p className="text-xs text-stone-500 max-w-sm mx-auto leading-relaxed">
            Create or join a private circle to write answers to prompts blindly, revealing entries together when everyone finishes.
          </p>
          <div className="pt-2">
            <button
              onClick={login}
              className="bg-[#1C1917] text-[#FBF9F5] text-xs px-5 py-2.5 rounded-xl hover:opacity-90 transition font-medium"
            >
              Sign In with Google
            </button>
          </div>
        ...
        <div className="space-y-8">
          ...
          {loading ? (
            ...
            <div className="border border-dashed border-stone-300 rounded-2xl p-8 text-center bg-white/40 space-y-2">
              ...
              <p className="text-xs text-stone-400">Create one or ask a friend for their invite code.</p>
            </div>
          ) : (
